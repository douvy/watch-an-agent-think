...
export const pressure: Scenario = {
  ...
  events: [
    { at: 0, tokensAfter: 800, type: "plan", planId: "p1",
      narration: "Fourteen files. The risk isn't difficulty — it's how much I must remember.",
      steps: [
    ...
    { at: 14700, tokensAfter: 2300, type: "tool_result", callId: "t2", ok: true, output: "renamed (1/14)",
      narration: "Every edit I make, I also have to carry. My memory is a window — everything I read or write sits in it." },
    ...
    { at: 43700, tokensAfter: 6900, type: "thought",
      branch: { choice: "pressure-memory", option: "compress" },
      narration: "Finished work folds to a sentence — I keep conclusions, drop the keystrokes.",
    ...
    { at: 54600, tokensAfter: 2000, type: "tool_call", id: "t6", tool: "edit",
      narration: "The summary tells me what's left. Good notes make forgetting safe.",
    ...
    { at: 76300, tokensAfter: 4170, type: "tool_call", id: "t9", tool: "bash",
      narration: "Last step — I don't declare victory, the build does.",
      why: "fourteen files of edits need one impartial witness",
