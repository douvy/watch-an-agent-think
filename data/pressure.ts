...
export const pressure: Scenario = {
  ...
  events: [
    { at: 0, tokensAfter: 800, type: "plan", planId: "p1",
      narration: "Fourteen files to update. A long grind.",
      steps: [
    ...
    { at: 5500, tokensAfter: 1600, type: "tool_result", callId: "t1", ok: true,
      narration: "53 spots across 14 files. Off I go.",
    ...
    { at: 24500, tokensAfter: 6400, type: "tool_result", callId: "t5", ok: true, output: "renamed (8/14)",
      narration: "Progress — but memory is filling fast." },
    { at: 27000, tokensAfter: 6800, type: "thought",
      narration: "85% full. I can't keep every detail.",
      text: "Context is at 85% and six files remain. Time to compress." },
    { at: 29500, tokensAfter: 1900, type: "compact",
      narration: "So I compress: keep a summary, drop details.",
    ...
    { at: 34500, tokensAfter: 2000, type: "tool_call", id: "t6", tool: "edit",
      narration: "Back to work — the summary says what's left.",
