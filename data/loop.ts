...
export const loop: Scenario = {
  ...
  events: [
    { at: 0, tokensAfter: 600, type: "plan", planId: "p1",
      narration: "First move: I write myself a plan.",
      steps: [
      "Run the tests",
    ...
    { at: 5000, tokensAfter: 1250, type: "tool_result", callId: "t1", ok: false,
      narration: "There's the failure. Now I'm hunting.",
    ...
    { at: 7500, tokensAfter: 1310, type: "thought",
      narration: "Before guessing, I go read the test.",
    ...
    { at: 11500, tokensAfter: 2000, type: "tool_result", callId: "t2", ok: true,
      narration: "It wants a clean date from a timestamp. Noted.",
    ...
    { at: 14500, tokensAfter: 2060, type: "thought",
      narration: "Now the code itself — what does it really do?",
      text: "The test passes an ISO timestamp. Now read the implementation." },
    { at: 16000, tokensAfter: 2100, type: "tool_call", id: "t3", tool: "read", input: "lib/utils.ts",
      narration: "I open the implementation next." },
    { at: 18500, tokensAfter: 2650, type: "tool_result", callId: "t3", ok: true,
      narration: "Found it — the code mangles the date first.",
      output: "const d = new Date(str.replace(/-/g, '/')) — manual string surgery before parsing" },
    { at: 21000, tokensAfter: 2700, type: "thought",
      narration: "That's the bug. I'm sure enough to act.",
    ...
    { at: 26500, tokensAfter: 2850, type: "tool_result", callId: "t4", ok: true, output: "1 file changed",
      narration: "Fixed — but I don't celebrate yet." },
    ...
    { at: 29000, tokensAfter: 2910, type: "tool_call", id: "t5", tool: "bash", input: "npm test",
      narration: "I re-run the tests. Fixes must be proven." },
    { at: 32500, tokensAfter: 3150, type: "tool_result", callId: "t5", ok: true, output: "12 passed, 0 failed",
      narration: "All green. That's the loop, complete." },
