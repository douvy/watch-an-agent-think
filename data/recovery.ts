...
export const recovery: Scenario = {
  ...
  durationMs: 58000,
  events: [
    { at: 0, tokensAfter: 700, type: "plan", planId: "p1", steps: [
    ...
    { at: 16500, tokensAfter: 1720, type: "tool_call", id: "t3", tool: "bash",
      input: "curl -s -o /dev/null -w '%{http_code}' /api/orders" },
    ...
    { at: 27000, tokensAfter: 2250, type: "plan", planId: "p2", steps: [
    ...
    { at: 30000, tokensAfter: 2310, type: "tool_call", id: "t4", tool: "bash", input: "curl -s /api/orders | head" },
    { at: 33000, tokensAfter: 3050, type: "tool_result", callId: "t4", ok: false,
      output: "TypeError: cannot read 'email' of null — at order.user.email (orders.ts:41)" },
